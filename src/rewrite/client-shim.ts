...
function route(value){if(typeof value!=="string"||skip.test(value)||value.indexOf(prefix)===0)return value;try{return prefix+"?url="+encodeURIComponent(token(new URL(value,base).href))}catch{return value}}
